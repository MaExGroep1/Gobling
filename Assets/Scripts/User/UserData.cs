...
namespace User
{
    public class UserData : Singleton<UserData>
    {
        ...
        private List<ItemScriptableObject> _inventory; // A list of Items that the player has
        public List<ItemScriptableObject> Inventory => _inventory;
        ...
        public void AddItemToInventory(ItemScriptableObject item) => _inventory.Add(item);

        /// <summary>
        /// Remove "item" to Inventory
        /// </summary>
        /// <param name="item">Item to remove</param>
        public bool RemoveItemFromInventory(ItemScriptableObject item)
        {
